...
## Consultez la météo
Vous voudrez probablement [consulter la météo](https://www.meteomedia.com/ca/previsions-meteo-horaires/quebec/saint-hippolyte "Météo pour Saint-Hippolyte sur Météo Média") avant de vous rendre au séjour. Ne serait-ce que pour savoir quel type de vêtement apporter ou choisir l'épaisseur de votre sac de couchage (la literie n'est pas fourni).
## Quoi apporter
